...
import (
	...
	"github.com/libp2p/go-libdht/key/trie"
)
...
var _ kad.RoutingTable[kad.Key256, kadtest.ID[kad.Key256]] = (*TrieRT[kad.Key256, kadtest.ID[kad.Key256]])(nil)
...
func (rt *TrieRT[K, N]) RemoveNode(n N) bool {
